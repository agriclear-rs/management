  ...
  (this.totalCodewords = e),
    ...
    (this.buildFunctionPattern = function () {
      ...
      return (
        ...
        6 < this.versionNumber && (t.setRegion(e - 11, 0, 3, 6), t.setRegion(0, e - 11, 6, 3)),
        t
      );
    }),
  ...
  (this.image = e),
    ...
    (this.sizeOfBlackWhiteBlackRunBothWays = function (e, t, n, i) {
      ...
      return (
        ...
        0 > n
          ? ((o = e / (e - n)), (n = 0))
          : n >= qrcode.width && ((o = (qrcode.width - 1 - e) / (n - e)), (n = qrcode.width - 1)),
    ...
    (this.findAlignmentInRegion = function (e, t, n, i) {
      ...
      if (((i = Math.max(0, t - r)), (t = Math.min(qrcode.width - 1, t + r)), 3 * e > t - i))
        throw "Error";
...
function BitMatrixParser(e) {
  ...
  (this.bitMatrix = e),
    ...
    (this.readFormatInformation = function () {
      ...
      for (
        e = this.copyBit(7, 8, e), e = this.copyBit(8, 8, e), e = this.copyBit(8, 7, e), t = 5;
        t >= 0;
        t--
      )
      ...
      for (var n = this.bitMatrix.Dimension, e = 0, i = n - 8, t = n - 1; t >= i; t--)
    ...
    (this.readVersion = function () {
      ...
      for (t = 0, r = 5; r >= 0; r--) for (i = e - 9; i >= n; i--) t = this.copyBit(r, i, t);
      if (
        ((this.parsedVersion = Version.decodeVersionInformation(t)),
        null != this.parsedVersion && this.parsedVersion.DimensionForVersion == e)
      )
...
function DataMask000() {
  (this.unmaskBitMatrix = function (e, t) {
    for (var n = 0; t > n; n++) for (var i = 0; t > i; i++) this.isMasked(n, i) && e.flip(i, n);
  }),
...
function ReedSolomonDecoder(e) {
  (this.field = e),
      ...
      if (!o)
        for (
          r = new GF256Poly(this.field, i),
            n = this.runEuclideanAlgorithm(this.field.buildMonomial(t, 1), r, t),
            r = n[1],
    ...
    (this.runEuclideanAlgorithm = function (e, t, n) {
      ...
      for (
        var i = this.field.One, r = this.field.Zero, o = this.field.Zero, s = this.field.One;
        ...
        for (
          t = a, s = this.field.Zero, r = e.getCoefficient(e.Degree), r = this.field.inverse(r);
    ...
    (this.findErrorMagnitudes = function (e, t, n) {
      for (var i = t.length, r = Array(i), o = 0; i > o; o++) {
        for (var s = this.field.inverse(t[o]), a = 1, h = 0; i > h; h++)
          o != h &&
            (a = this.field.multiply(a, GF256.addOrSubtract(1, this.field.multiply(t[h], s))));
...
function GF256Poly(e, t) {
  ...
  if (n > 1 && 0 == t[0]) {
    ...
    if (i == n) this.coefficients = e.Zero.coefficients;
      ...
      for (this.coefficients = Array(n - i), n = 0; n < this.coefficients.length; n++)
    ...
    (this.multiply1 = function (e) {
      ...
      for (var i = e.length, r = Array(n + i - 1), o = 0; n > o; o++)
        for (var s = t[o], a = 0; i > a; a++)
          r[o + a] = GF256.addOrSubtract(r[o + a], this.field.multiply(s, e[a]));
...
function FinderPatternFinder() {
  (this.image = null),
    ...
    (this.crossCheckVertical = function (e, t, n, i) {
      for (
        var r = this.image, o = qrcode.height, s = this.CrossCheckStateCount, a = e;
      ...
      return s[4] >= n || 5 * Math.abs(s[0] + s[1] + s[2] + s[3] + s[4] - i) >= 2 * i
        ? 0 / 0
    ...
    (this.crossCheckHorizontal = function (e, t, n, i) {
      for (
        var r = this.image, o = qrcode.width, s = this.CrossCheckStateCount, a = e;
      ...
      return s[4] >= n || 5 * Math.abs(s[0] + s[1] + s[2] + s[3] + s[4] - i) >= i
        ? 0 / 0
        : this.foundPatternCross(s)
        ? this.centerFromEnd(s, a)
        : 0 / 0;
    ...
    (this.handlePossibleCenter = function (e, t, n) {
      ...
      if (
        ...
        !isNaN(t) &&
          ((n = this.crossCheckHorizontal(Math.floor(n), Math.floor(t), e[2], i)), !isNaN(n)))
      ) {
        e = i / 7;
    ...
    (this.findRowSkip = function () {
      ...
      for (var t = null, n = 0; e > n; n++) {
        ...
        if (i.Count >= CENTER_QUORUM) {
          if (null != t)
            return (
              (this.hasSkipped = !0), Math.floor((Math.abs(t.X - i.X) - Math.abs(t.Y - i.Y)) / 2)
            );
          t = i;
        }
      }
    ...
    (this.haveMultiplyConfirmedCenters = function () {
      ...
      for (var e = t / n, o = 0, i = 0; n > i; i++)
        (r = this.possibleCenters[i]), (o += Math.abs(r.EstimatedModuleSize - e));
      return 0.05 * t >= o;
    }),
                ...
                if ((a = this.handlePossibleCenter(o, s, h)))
                  (i = 2),
                    this.hasSkipped
                      ...
                      : ((a = this.findRowSkip()), a > o[2] && ((s += a - o[2] - i), (h = n - 1)));
                else {
                  do h++;
    ...
    (this.handlePossibleCenter = function (e, t, n) {
      ...
      if (
        ...
        (n = new AlignmentPattern(n, t, e)),
          this.possibleCenters.push(n),
          null != this.resultPointCallback && this.resultPointCallback.foundPossibleResultPoint(n);
      }
      return null;
    }),
    (this.find = function () {
      for (
        var t = this.startX, r = this.height, o = t + i, s = n + (r >> 1), a = [0, 0, 0], h = 0;
        r > h;
        h++
      ) {
        ...
        if (this.foundPatternCross(a) && ((f = this.handlePossibleCenter(a, c, o)), null != f))
          return f;
      }
  ...
  (this.blockPointer = 0),
    ...
    (this.getNextBits = function (e) {
      ...
      if (e < this.bitPointer + 1 + 16) {
        ...
        (i = (this.blocks[this.blockPointer] & i) << (e - (this.bitPointer + 1))),
          this.blockPointer++;
        ...
        return (
          ...
          (t =
            i +
            r +
            ((this.blocks[this.blockPointer] & n) >> (8 - (e - (this.bitPointer + 1 + 8))))),
    ...
    (this.NextMode = function () {
      return this.blockPointer > this.blocks.length - this.numErrorCorrectionCode - 2
        ? 0
        : this.getNextBits(4);
    }),
    ...
    (this.getFigureString = function (e) {
      ...
      do
        e >= 3
          ? ((t = this.getNextBits(10)), 100 > t && (n += "0"), 10 > t && (n += "0"), (e -= 3))
          : 2 == e
    ...
    this.__defineGetter__("DataByte", function () {
      for (var e = []; ; ) {
        ...
        switch (t) {
          case 1:
            for (
              var t = this.getFigureString(dataLength), n = Array(t.length), i = 0;
              i < t.length;
              i++
            )
              n[i] = t.charCodeAt(i);
          ...
          case 2:
            for (
              t = this.getRomanAndFigureString(dataLength), n = Array(t.length), i = 0;
              i < t.length;
              i++
            )
              n[i] = t.charCodeAt(i);
  ...
  checkAndNudgePoints: function (e, t) {
    for (var n = qrcode.width, i = qrcode.height, r = !0, o = 0; o < t.Length && r; o += 2) {
      ...
      (r = !1),
        ...
        -1 == a ? ((t[o + 1] = 0), (r = !0)) : a == i && ((t[o + 1] = i - 1), (r = !0));
    }
    for (r = !0, o = t.Length - 2; o >= 0 && r; o -= 2) {
      if (((s = Math.floor(t[o])), (a = Math.floor(t[o + 1])), -1 > s || s > n || -1 > a || a > i))
  ...
  (qrcode = {
    ...
    decode: function (e) {
      ...
      (i.onload = function () {
        ...
        null != n &&
          ((n = n.getContext("2d")), n.clearRect(0, 0, 320, 240), n.drawImage(i, 0, 0, 320, 240)),
          (e.width = i.width),
          (e.height = i.height),
          t.drawImage(i, 0, 0),
        ...
        for (var i = 0; i < qrcode.height; i++)
          for (var r = 0; r < qrcode.width; r++) {
            ...
            (qrcode.imagedata.data[o] = 0),
              ...
              (qrcode.imagedata.data[o + 2] = n[r + i * qrcode.width] ? 255 : 0);
          }
...
qrcode.orderBestPatterns = function (e) {
  ...
  var o = i.x,
    s = i.y;
  0 > (r.x - o) * (n.y - s) - (r.y - s) * (n.x - o) && ((o = n), (n = r), (r = o)),
    (e[0] = n),
    (e[1] = i),
    (e[2] = r);
};
...
var Html5Qrcode = (function () {
  function e(t, n) {
    if ((_classCallCheck(this, e), !qrcode))
      ...
      [
        {
          ...
          value: function (t, n, i, a) {
            ...
            if (
              ...
              var h = c.qrbox;
              if (h < e.MIN_QR_BOX_SIZE)
                throw "minimum size of 'config.qrbox' is ".concat(e.MIN_QR_BOX_SIZE, "px.");
              if (h > d)
            ...
            var u = function (t) {
              return new Promise(function (n, i) {
                var h;
                (o._localMediaStream = t),
                  (h = r._createVideoElement(d)),
                  o._element.append(h),
                  (h.onabort = i),
                  (h.onerror = i),
                  (h.onplaying = function () {
                    !(function (e, t) {
                      ...
                      var i = s && n <= t,
                        a = { x: 0, y: 0, width: e, height: t },
                        d = i ? r._getShadedRegionBounds(e, t, n) : a,
                        h = r._createCanvasElement(d.width, d.height),
                        u = h.getContext("2d");
                      (u.canvas.width = d.width),
                        (u.canvas.height = d.height),
                        l.append(h),
                        i && r._possiblyInsertShadingElement(l, t, d),
                        (o._qrRegion = d),
                        (o._context = u),
                        (o._canvasElement = h);
            ...
            return new Promise(function (e, n) {
              if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
                ...
                var a = { video: { optional: [{ sourceId: t }] } };
                navigator.getUserMedia(
                  a,
                  function (t) {
                    u(t)
                ...
                o = function () {
                  (t._localMediaStream = null),
                    ...
                    (function () {
                      for (
                        ;
                        t._element.getElementsByClassName(e.SHADED_REGION_CLASSNAME).length;
              ...
              (o.onload = function () {
                var t = o.width,
                  ...
                  h = (function t(n, i, a, r) {
                    if (n <= a && i <= r)
                      return { x: (a - n) / 2, y: (r - i) / 2, width: n, height: i };
                    var o = n,
                      c = i;
                    return (
                      n > a && ((i *= a / n), (n = a)),
                      i > r && ((n *= r / i), (i = r)),
                      e._log(
                        "Image downsampled from ".concat(o, "X").concat(c) +
                ...
                if (n) {
                  ...
                  (_.canvas.width = l),
                    (_.canvas.height = d),
                    _.drawImage(o, 0, 0, t, c, h.x, h.y, h.width, h.height);
                }
                var g = i._createCanvasElement(h.width, h.height);
                s.appendChild(g);
                var f = g.getContext("2d");
                (f.canvas.width = h.width),
                  (f.canvas.height = h.height),
                  f.drawImage(o, 0, 0, t, c, 0, 0, h.width, h.height);
                try {
                  a(qrcode.decode());
                } catch (e) {
        ...
        },
        {
          ...
          value: function (t, n, i) {
            ...
            if (0 != i.x || 0 != i.y) {
              var r = {};
              (r[e.SHADED_LEFT] = this._createShadedElement(n, i, e.SHADED_LEFT)),
                (r[e.SHADED_RIGHT] = this._createShadedElement(n, i, e.SHADED_RIGHT)),
                (r[e.SHADED_TOP] = this._createShadedElement(n, i, e.SHADED_TOP)),
                (r[e.SHADED_BOTTOM] = this._createShadedElement(n, i, e.SHADED_BOTTOM)),
        ...
        },
        {
          ...
          value: function (t, n, i) {
            ...
            switch (
              ...
              (a.className = e.SHADED_REGION_CLASSNAME),
              (a.id = "".concat(e.SHADED_REGION_CLASSNAME, "_").concat(i)),
              (a.style.background = "#0000007a"),
              i)
            ) {
              case e.SHADED_LEFT:
                (a.style.top = "0px"),
                  (a.style.left = "0px"),
                  (a.style.width = "".concat(n.x, "px")),
                  (a.style.height = "".concat(t, "px"));
                break;
              case e.SHADED_RIGHT:
                (a.style.top = "0px"),
              ...
              case e.SHADED_TOP:
                (a.style.top = "0px"),
                  (a.style.left = "".concat(n.x, "px")),
                  (a.style.width = "".concat(n.width, "px")),
                  (a.style.height = "".concat(n.y, "px"));
                break;
              ...
              r = function (n, r) {
                ...
                var o = (function () {
                  ...
                  switch (
                    ...
                    (t.style.backgroundColor = e.BORDER_SHADER_DEFAULT_COLOR),
                    i)
                  ) {
                    case e.SHADED_LEFT:
                    case e.SHADED_RIGHT:
                ...
                (o.style.top = "".concat(n, "px")),
                  (o.style.left = "".concat(r, "px")),
                  t.appendChild(o),
                  a.borderShaders || (a.borderShaders = []),
                  a.borderShaders.push(o);
              },
              o = null,
              c = null,
              s = null,
              ...
              if (
                      ...
                      navigator.mediaDevices
                        ...
                        .then(function (n) {
                          for (var a = [], r = 0; r < n.length; r++) {
                            var o = n[r];
                            "videoinput" == o.kind && a.push({ id: o.deviceId, label: o.label });
                          }
                ...
                MediaStreamTrack.getSources(function (n) {
                  for (var i = [], a = 0; a !== n.length; ++a) {
                    var r = n[a];
                    "video" === r.kind && i.push({ id: r.id, label: r.label });
                  }
